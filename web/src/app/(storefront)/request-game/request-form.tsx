    ...
    return (
      <div className="text-center space-y-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground font-bold text-sm px-6 py-3 rounded-xl hover:opacity-90 transition mx-auto"
        >
