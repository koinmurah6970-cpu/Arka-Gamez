...
import { WA_ADMIN_NUMBER, STORE_NAME } from "@/lib/constants";
...
export default function OrderConfirmationPage({
  ...
  const waUrl = order
    ? `https://wa.me/${WA_ADMIN_NUMBER}?text=${encodeURIComponent(buildWhatsAppMessage(order))}`
    : `https://wa.me/${WA_ADMIN_NUMBER}?text=${encodeURIComponent(
